...
# Usually, we use 0.05 as criteria.
	...
	alpha, xmin, ks, Loglike = cr.tplfit(burst,bound) #OG matlab hardcodes this to 40. I think that's correct. I'm going to do this. alpha, xmin, ks, Loglike = cr.tplfit(burst,boundary)
	# print(xmin)
	# print(alpha)
	xmax = np.max(burst)
	N   = np.size(burst)
