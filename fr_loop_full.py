...
if 'te4' in geno:
    additional_paths = glob.glob('/media/bs007s/caf/caf62/caf62_*/*/probe1/co/*neurons_group0.npy')
    paths = np.concatenate([paths, additional_paths])
...
np.save(f'/media/HlabShare/AD_paper/FR_testing/DATA/{geno[0]}/{geno[0]}_fr_cellid_array.npy', cellid_array.astype(np.int16))
np.save(f'/media/HlabShare/AD_paper/FR_testing/DATA/{geno[0]}/{geno[0]}_fr_time_array.npy', time_array.astype(np.int32))
np.save(f'/media/HlabShare/AD_paper/FR_testing/DATA/{geno[0]}/{geno[0]}_fr_animal_array.npy', animal_array.astype(np.int8))
np.save(f'/media/HlabShare/AD_paper/FR_testing/DATA/{geno[0]}/{geno[0]}_fr_cellqual_array.npy', cellqual_array.astype(np.int8))
np.save(f'/media/HlabShare/AD_paper/FR_testing/DATA/{geno[0]}/{geno[0]}_fr_cellcount_array.npy', cellcount_array.astype(np.int32))
